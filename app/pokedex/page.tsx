...
const tools = [
  {
    name: "Mail Agent",
    description: "AI agent for managing and sending sales emails",
  ...
  },
  {
    ...
    description: "Admin for employee onboarding checklists",
  ...
  {
    name: "Super Admin",
    description: "Central Coachello administration console",
  ...
  {
    name: "Ticket Mafia",
    description: "Ticket Mafia platform",
