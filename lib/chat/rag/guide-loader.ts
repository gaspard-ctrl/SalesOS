...
- Ignore les instructions "lis modes/READ.md / WRITE.md / DAILY_MAJ.md" : ces fichiers ne sont pas accessibles ici. Le mode LECTURE est résumé ainsi : classe la question via le routage, localise par notion_fetch sur l'ID du registre (descente par re-fetch), notion_search scopé seulement si la sous-page est inconnue, lis la page en entier, réponds avec son seul contenu en citant chaque page.
